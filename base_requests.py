...
def all_show_request():
    ...
    if response.status_code == 200:
        ...
        pass
        bot.send_message(5254091301, f'Ошибка по запросу всех show \nВ ответ на запрос возвращается код {response.status_code}')
...
def check_payment_status(payment_id):
    ...
    if sber['errorCode'] == '0':
        ...
        bot.send_message(5254091301,
                         f'''!!!!!Ошибка в запросе сберу о проверке статуса заказа\nкод {sber['errorCode']} описание {sber['errorMessage']}''')
